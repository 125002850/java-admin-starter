...
import com.demo.dict.controller.GlobalDictController;
...
import com.demo.dict.query.globaldict.GlobalDictItemSceneQueryMapper;
import com.demo.dict.query.globaldict.GlobalDictItemSceneQueryDefinition;
...
@SpringBootTest(
        ...
        properties = {
                "spring.datasource.url=jdbc:h2:mem:java-demo-system-dict;MODE=MySQL;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false",
