...
class ModuleBoundaryTests {
    ...
    void admin_system_packages_must_not_depend_on_admin_boot() {
        ArchRule rule = noClasses()
                .that().resideInAnyPackage("com.example.admin.file..", "com.example.admin.staff..", "com.example.admin.dict..", "com.example.admin.export..")
                .should().dependOnClassesThat().resideInAPackage("com.example.admin.boot..");
        rule.check(allClasses);
    }
    ...
    void admin_system_must_not_depend_on_admin_iam_service_layer() {
        ArchRule rule = noClasses()
                ...
                .or().resideInAPackage("com.example.admin.staff..")
                .or().resideInAPackage("com.example.admin.dict..")
                .or().resideInAPackage("com.example.admin.export..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "com.example.admin.iam.service..",
                        "com.example.admin.iam.infra..",
                        "com.example.admin.iam.app..",
                        "com.example.admin.iam.security.."
                );
        rule.check(allClasses);
    }
    ...
    void admin_iam_must_not_depend_on_admin_mdm_or_system_implementations() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.example.admin.iam..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "com.example.admin.mdm..",
                        "com.example.admin.file..",
                        "com.example.admin.staff..",
                        "com.example.admin.dict..",
                        "com.example.admin.export.."
                );
        rule.check(allClasses);
    }
    ...
    void admin_iam_controller_must_not_depend_on_service_mapper_or_entity() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.example.admin.iam.controller..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "com.example.admin.iam.service..",
                        "com.example.admin.iam.infra.mapper..",
                        "com.example.admin.iam.infra.entity.."
                );
        rule.check(allClasses);
    }
