...
import com.oigit.admin.iam.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((request, response, authException) ->
                                com.oigit.admin.iam.security.IamAccessDeniedHandler.writeUnauthorized(objectMapper, response))
                        .accessDeniedHandler((request, response, accessDeniedException) ->
                                com.oigit.admin.iam.security.IamAccessDeniedHandler.writeForbidden(objectMapper, response))
                )
