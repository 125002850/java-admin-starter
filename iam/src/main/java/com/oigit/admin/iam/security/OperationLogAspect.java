...
import com.oigit.admin.iam.event.OperationLogEvent;
import com.oigit.admin.iam.service.ClientRequestInfo;
import com.oigit.admin.iam.service.ClientRequestInfoResolver;
...
private static final int MAX_SUMMARY_LENGTH = 2048;
    ...
    @Around("@annotation(com.oigit.admin.iam.annotation.OperationLog)")
