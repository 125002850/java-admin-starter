...
public class RequiresPermissionAspect {
    ...
    @Before(
            "@annotation(com.oigit.admin.iam.annotation.RequiresPermission) || @within(com.oigit.admin.iam.annotation.RequiresPermission)")
    ...
    private RequiresPermission resolveAnnotation(JoinPoint joinPoint) {
        ...
        RequiresPermission annotation =
                AnnotatedElementUtils.findMergedAnnotation(
                        signature.getMethod(), RequiresPermission.class);
        if (annotation != null) {
            return annotation;
        }
        return AnnotatedElementUtils.findMergedAnnotation(
                signature.getDeclaringType(), RequiresPermission.class);
    }
}
