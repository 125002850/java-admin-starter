...
import com.demo.iam.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((request, response, authException) ->
                                com.demo.iam.security.IamAccessDeniedHandler.writeUnauthorized(objectMapper, response))
                        .accessDeniedHandler((request, response, accessDeniedException) ->
                                com.demo.iam.security.IamAccessDeniedHandler.writeForbidden(objectMapper, response))
                )
