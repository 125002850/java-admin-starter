...
import com.demo.iam.event.OperationLogEvent;
import com.demo.iam.service.ClientRequestInfo;
...
public class OperationLogAspect {
    ...
    @Around("@annotation(com.demo.iam.annotation.OperationLog)")
    ...
    private String mask(String source) {
        ...
        return SENSITIVE_JSON_FIELD.matcher(source).replaceAll("\"$1\":\"***\"");
    }
