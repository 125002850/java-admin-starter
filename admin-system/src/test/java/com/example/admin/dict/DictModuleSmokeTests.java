package com.example.admin.dict;
...
import com.example.admin.dict.app.DictAppService;
import com.example.admin.dict.controller.GlobalDictController;
...
@SpringBootTest(
        ...
        properties = {
                "spring.datasource.url=jdbc:h2:mem:java-admin-starter-system-dict;MODE=MySQL;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false",
