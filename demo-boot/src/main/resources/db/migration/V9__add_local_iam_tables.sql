...
values
  ...
  (1100, 1000, 'iam_staff', '员工管理', 'MENU', '/system/staff', '/system/staff/index', 'Users', 10, 0, 0, 'ENABLED', 'iam:staff:query', null, 0, 0, 0),
  ...
  (1200, 1000, 'iam_dept', '部门管理', 'MENU', '/system/dept', '/system/dept/index', 'Network', 20, 0, 0, 'ENABLED', 'iam:dept:manage', null, 0, 0, 0),
  (1300, 1000, 'iam_role', '角色管理', 'MENU', '/system/role', '/system/role/index', 'Shield', 30, 0, 0, 'ENABLED', 'iam:role:manage', null, 0, 0, 0),
  (1400, 1000, 'iam_menu', '菜单管理', 'MENU', '/system/menu', '/system/menu/index', 'Menu', 40, 0, 0, 'ENABLED', 'iam:menu:manage', null, 0, 0, 0),
  (1500, 1000, 'iam_login_log', '登录日志', 'MENU', '/system/login-log', '/system/login-log/index', 'FileClock', 50, 0, 0, 'ENABLED', 'iam:log:login:query', null, 0, 0, 0),
  (1600, 1000, 'iam_operation_log', '操作日志', 'MENU', '/system/operation-log', '/system/operation-log/index', 'ScrollText', 60, 0, 0, 'ENABLED', 'iam:log:operation:query', null, 0, 0, 0),
  (2000, null, 'mdm', '主数据', 'DIR', '/mdm', null, 'Database', 20, 0, 0, 'ENABLED', null, '主数据目录', 0, 0, 0),
  (2100, 2000, 'mdm_dict', '字典管理', 'MENU', '/mdm/dict', '/mdm/dict/index', 'BookOpen', 10, 0, 0, 'ENABLED', null, null, 0, 0, 0),
  (3000, null, 'system_integration', '系统集成', 'DIR', '/integration', null, 'Boxes', 30, 0, 0, 'ENABLED', null, '系统集成目录', 0, 0, 0),
  (3100, 3000, 'file_storage', '文件管理', 'MENU', '/integration/file', '/integration/file/index', 'FolderUp', 10, 0, 0, 'ENABLED', null, null, 0, 0, 0),
  (4000, null, 'export_center', '导出中心', 'MENU', '/export', '/export/index', 'Download', 40, 0, 0, 'ENABLED', null, null, 0, 0, 0);
