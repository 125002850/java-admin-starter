...
class PlatformModulesIntegrationTests {
    ...
    @Test void invalidGatewayIdentityIsRejected() throws Exception {
        mvc.perform(post("/api/system/schedule/job/page").header("X-User-Id", "invalid")
    ...
    private JsonNode call(String path, Object payload) throws Exception {
        return json.readTree(mvc.perform(post(path).header("X-User-Id", "1001").header("X-User-Name", "backport-verifier")
