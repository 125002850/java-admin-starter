package com.oigit.admin.file.dto.req;

import io.swagger.v3.oas.annotations.media.Schema;
import jakarta.validation.constraints.NotBlank;
import jakarta.validation.constraints.Pattern;

@Schema(description = "获取直传凭证请求")
public class FetchDirectUploadCredentialReqDTO {
    ...
    @Schema(description = "对象键，可选", example = "avatar/user/2026/05/19/example.png")
