package com.oigit.admin.export.infra.async;
...
@Component
public class AsyncExportTaskDispatcher implements ExportTaskDispatcher {

    private final TaskExecutor taskExecutor;

    public AsyncExportTaskDispatcher(@Qualifier("exportTaskExecutor") TaskExecutor taskExecutor) {
